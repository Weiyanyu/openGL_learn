...
int main()
{
    ...
    while(!glfwWindowShouldClose(glfwWindow))
    {
        ...
        LightingCubeShader.setVec3("light.ambient", glm::value_ptr(glm::vec3(0.2f, 0.2f, 0.2f)));
        LightingCubeShader.setVec3("light.diffuse", glm::value_ptr(glm::vec3(0.5f, 0.5f, 0.5f)));
